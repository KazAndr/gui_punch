...
class App(QMainWindow):
    ...
    def initUI(self):
        ...
        layout_labelibg.addWidget(self.to_pulse_and_RFI, 2, 0, 1, 1)
        layout_labelibg.addWidget(self.to_unknown, 2, 1, 1, 1)
        ...
        self.to_pulse_and_RFI.clicked.connect(
            lambda: self.set_label('Pulse+RFI'))
