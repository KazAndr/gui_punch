...
class App(QMainWindow):
    ...
    def initUI(self):
        ...
        self.to_w_pulse = QPushButton('Weak Pulse')
        self.to_s_pulse = QPushButton('Strong Pulse')
        self.to_BBRFI = QPushButton('BBRFI')
        self.to_NBRFI = QPushButton('NBRFI')
        self.to_weak_pulse_and_BBRFI = QPushButton('WP+BBRFI')
        self.to_weak_pulse_and_NBRFI = QPushButton('WP+NBRFI')
        self.to_strong_pulse_and_BBRFI = QPushButton('SP+BBRFI')
        ...
        # addWidget(QWidget, row, column, rows, columns)
        layout_labelibg.addWidget(self.to_w_pulse, 0, 0, 1, 1)
        layout_labelibg.addWidget(self.to_s_pulse, 0, 1, 1, 1)
        layout_labelibg.addWidget(self.to_BBRFI, 1, 0, 1, 1)
        layout_labelibg.addWidget(self.to_NBRFI, 1, 1, 1, 1)
        layout_labelibg.addWidget(self.to_weak_pulse_and_BBRFI, 2, 0, 1, 1)
        layout_labelibg.addWidget(self.to_weak_pulse_and_NBRFI, 2, 1, 1, 1)
        layout_labelibg.addWidget(self.to_strong_pulse_and_BBRFI, 3, 0, 1, 1)
        layout_labelibg.addWidget(self.to_strong_pulse_and_NBRFI, 3, 1, 1, 1)
        layout_labelibg.addWidget(self.to_None, 4, 0, 1, 1)
        layout_labelibg.addWidget(self.to_unknown, 4, 1, 1, 1)
        ...
        self.to_w_pulse.setEnabled(False)
        self.to_s_pulse.setEnabled(False)
        self.to_BBRFI.setEnabled(False)
        self.to_NBRFI.setEnabled(False)
        self.to_weak_pulse_and_BBRFI.setEnabled(False)
        self.to_weak_pulse_and_NBRFI.setEnabled(False)
        self.to_strong_pulse_and_BBRFI.setEnabled(False)
        self.to_strong_pulse_and_NBRFI.setEnabled(False)
        ...
        self.to_NBRFI.clicked.connect(lambda: self.set_label('NBRFI'))
        self.to_weak_pulse_and_BBRFI.clicked.connect(
            lambda: self.set_label('WP&BBRFI')
        )
        self.to_weak_pulse_and_NBRFI.clicked.connect(
            lambda: self.set_label('WP&NBRFI')
        )
        self.to_strong_pulse_and_BBRFI.clicked.connect(
            lambda: self.set_label('SP&BBRFI')
        )
        self.to_strong_pulse_and_NBRFI.clicked.connect(
            lambda: self.set_label('SP&NBRFI')
        )
    ...
    def start_labeling(self):
        ...
        if self.fil_file:
            ...
            self.to_w_pulse.setEnabled(True)
            self.to_s_pulse.setEnabled(True)
            self.to_BBRFI.setEnabled(True)
            self.to_NBRFI.setEnabled(True)
            self.to_weak_pulse_and_BBRFI.setEnabled(True)
            self.to_weak_pulse_and_NBRFI.setEnabled(True)
            self.to_strong_pulse_and_BBRFI.setEnabled(True)
            self.to_strong_pulse_and_NBRFI.setEnabled(True)
